...
def public_list_correct_list_id(client):
	...
	public_list =client.public_list(list_id,access_token)
	assert public_list['products'][0]['owner']['firstName']=='James'

def public_list_not_correct_list_id(client):
	...
	assert check_exception(e, 'код ошибки', 'к примеру, не существует такой list_id')
